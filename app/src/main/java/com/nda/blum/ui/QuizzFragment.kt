    ...
    override fun onCreateView(
        ...
        bindingQuizz.txtQuestion1Answer1.setOnClickListener {
            if(bindingQuizz.txtQuestion1Answer1.currentTextColor == Color.parseColor("#FFFFFF")){
                ...
                if(bindingQuizz.txtQuestion1Answer2.currentTextColor == Color.parseColor("#FFFFFF") || bindingQuizz.txtQuestion1Answer3.currentTextColor == Color.parseColor("#FFFFFF")){
                    minusProgress(bindingQuizz)
                }
        ...
        bindingQuizz.txtQuestion1Answer2.setOnClickListener {
            if(bindingQuizz.txtQuestion1Answer2.currentTextColor == Color.parseColor("#FFFFFF")){
                ...
                if(bindingQuizz.txtQuestion1Answer1.currentTextColor == Color.parseColor("#FFFFFF") || bindingQuizz.txtQuestion1Answer2.currentTextColor == Color.parseColor("#FFFFFF")){
                    minusProgress(bindingQuizz)
                }
                addProgress(bindingQuizz)
                bindingQuizz.txtQuestion1Answer1.setBackgroundResource(R.drawable.white_rounded_shape_purple_stroke)
        ...
        bindingQuizz.txtQuestion1Answer3.setOnClickListener {
            if(bindingQuizz.txtQuestion1Answer3.currentTextColor == Color.parseColor("#FFFFFF")){
                ...
                if(bindingQuizz.txtQuestion1Answer2.currentTextColor == Color.parseColor("#FFFFFF") || bindingQuizz.txtQuestion1Answer1.currentTextColor == Color.parseColor("#FFFFFF")){
                    minusProgress(bindingQuizz)
                }
                addProgress(bindingQuizz)
                bindingQuizz.txtQuestion1Answer1.setBackgroundResource(R.drawable.white_rounded_shape_purple_stroke)
        ...
        bindingQuizz.txtQuestion5Answer1.setOnClickListener {
            if(bindingQuizz.txtQuestion5Answer1.currentTextColor == Color.parseColor("#FFFFFF")){
                bindingQuizz.txtQuestion5Answer1.setBackgroundResource(R.drawable.white_rounded_shape_purple_stroke)
                bindingQuizz.txtQuestion5Answer1.setTextColor( Color.parseColor("#000000") )
                minusProgress(bindingQuizz)
            }else{
                bindingQuizz.txtQuestion5Answer1.setBackgroundResource(R.drawable.purple_rounded_shape)
                bindingQuizz.txtQuestion5Answer1.setTextColor( Color.parseColor("#FFFFFF") )
                addProgress(bindingQuizz)
                ...
                bindingQuizz.txtQuestion5Answer3.setBackgroundResource(R.drawable.white_rounded_shape_purple_stroke)
                bindingQuizz.txtQuestion5Answer3.setTextColor( Color.parseColor("#000000") )
            }
        }

        bindingQuizz.txtQuestion5Answer2.setOnClickListener {
            if(bindingQuizz.txtQuestion5Answer2.currentTextColor == Color.parseColor("#FFFFFF")){
                bindingQuizz.txtQuestion5Answer2.setBackgroundResource(R.drawable.white_rounded_shape_purple_stroke)
                bindingQuizz.txtQuestion5Answer2.setTextColor( Color.parseColor("#000000") )
                minusProgress(bindingQuizz)
            }else{
                bindingQuizz.txtQuestion5Answer2.setBackgroundResource(R.drawable.purple_rounded_shape)
                bindingQuizz.txtQuestion5Answer2.setTextColor( Color.parseColor("#FFFFFF") )
                addProgress(bindingQuizz)
                bindingQuizz.txtQuestion5Answer1.setBackgroundResource(R.drawable.white_rounded_shape_purple_stroke)
                bindingQuizz.txtQuestion5Answer1.setTextColor( Color.parseColor("#000000") )
                bindingQuizz.txtQuestion5Answer3.setBackgroundResource(R.drawable.white_rounded_shape_purple_stroke)
        ...
        bindingQuizz.txtQuestion5Answer3.setOnClickListener {
            if(bindingQuizz.txtQuestion5Answer3.currentTextColor == Color.parseColor("#FFFFFF")){
                bindingQuizz.txtQuestion5Answer3.setBackgroundResource(R.drawable.white_rounded_shape_purple_stroke)
                bindingQuizz.txtQuestion5Answer3.setTextColor( Color.parseColor("#000000") )
                minusProgress(bindingQuizz)
            }else{
                bindingQuizz.txtQuestion5Answer3.setBackgroundResource(R.drawable.purple_rounded_shape)
                bindingQuizz.txtQuestion5Answer3.setTextColor( Color.parseColor("#FFFFFF") )
                addProgress(bindingQuizz)
                bindingQuizz.txtQuestion5Answer1.setBackgroundResource(R.drawable.white_rounded_shape_purple_stroke)
                bindingQuizz.txtQuestion5Answer1.setTextColor( Color.parseColor("#000000") )
                bindingQuizz.txtQuestion5Answer2.setBackgroundResource(R.drawable.white_rounded_shape_purple_stroke)
